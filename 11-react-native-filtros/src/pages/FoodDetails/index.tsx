...
const FoodDetails: React.FC = () => {
  ...
  const cartTotal = useMemo(() => {
    const extrasValue = extras.reduce((prev, current) => {
      return current.quantity * current.value + prev;
    }, 0);

    return (food.price + extrasValue) * foodQuantity;
